...
const ColdOutreach = () => {
    ...
    return (
        <div className='cold-outreach'>
            <iframe width="560" height="315" title='ass ign ment' src="https://www.youtube.com/embed/2uqgQ3i1EEU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
