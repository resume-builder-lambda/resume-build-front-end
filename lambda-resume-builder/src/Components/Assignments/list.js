...
export const assignments = [

    {
        ...
        assigns: [
            ...
            '2: Write our a paragrapg describing your priorities in a company and what type of environment would be the best fit for you.',
            "3: If you haven't already, joing #career_help to get career tips from peers and be in the know about Career Coach-led office hours."
        ]
    },
    {
    ...
    },
    {
        ...
        img: `${group}`, link: '/dashboard/coming-soon',
        assigns: [
            'Do Things',
            'Do Stuff',
            'Do More'
    ...
    },
    {
        ...
        img: `${behavior}`, link: '/dashboard/coming-soon',
        assigns: [
            'Do Things',
            'Do Stuff',
            'Do More'
