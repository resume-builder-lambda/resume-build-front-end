...
export const assignments = [
    ...
    {name: 'Behavoiral Interviewing and Star Stories',  img: `${behavior}`,link:'/dashboard/coming-soon', assigns:['Do Things','Do Stuff','Do More'] },
